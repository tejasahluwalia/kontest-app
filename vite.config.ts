...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{
				find: "@client",
				replacement: resolve(import.meta.dirname, "./src/client"),
			},
			{
				find: "@server",
				replacement: resolve(import.meta.dirname, "./src/server"),
			},
			{ find: "@db", replacement: resolve(import.meta.dirname, "./src/db") },
		],
	},
	optimizeDeps: {
