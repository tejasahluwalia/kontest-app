...
export const BreadcrumbsLinkBaseComponent = <T extends ValidComponent = "a">(
...
const BreadcrumbsLinkComponent = createLink(BreadcrumbsLinkBaseComponent);

export const BreadcrumbsLink: LinkComponent<
	typeof BreadcrumbsLinkBaseComponent
> = (props) => {
	return <BreadcrumbsLinkComponent {...props} />;
};
