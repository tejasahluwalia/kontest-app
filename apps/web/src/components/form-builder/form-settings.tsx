				...
				<CardContent class="space-y-4">
					<div>
						...
						<Input
							...
							onInput={(e) =>
								updateFormSettings({ name: e.currentTarget.value })
							}
						/>
					</div>
					...
					<div>
						...
						<TextField>
							<TextFieldTextArea
								...
								onInput={(e) =>
									updateFormSettings({ description: e.currentTarget.value })
								}
								rows={4}
							/>
						</TextField>
						<p class="text-xs text-muted-foreground mt-1">
							This description will be shown to applicants at the top of the
							form
						</p>
					</div>
				</CardContent>
				...
				<CardContent>
					<TextField>
						<TextFieldTextArea
							...
							onInput={(e) =>
								updateFormSettings({ rules: e.currentTarget.value })
							}
							rows={6}
				...
				<CardContent>
					<TextField>
						<TextFieldTextArea
							...
							onInput={(e) =>
								updateFormSettings({ eligibility: e.currentTarget.value })
							}
							rows={6}
