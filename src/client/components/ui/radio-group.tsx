...
const RadioGroup = <T extends ValidComponent = "div">(
	...
	const others = omit(props as RadioGroupRootProps, "class");
	return (
...
const RadioGroupItem = <T extends ValidComponent = "div">(
	...
	const others = omit(props as RadioGroupItemProps, "class", "children");
	return (
...
const RadioGroupItemLabel = <T extends ValidComponent = "label">(
	...
	const others = omit(props as RadioGroupLabelProps, "class");
	return (
