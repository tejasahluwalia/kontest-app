...
const Toaster = <T extends ValidComponent = "ol">(
	...
	const others = omit(props as ToastListProps, "class");
	return (
		<Portal>
...
const Toast = <T extends ValidComponent = "li">(
	...
	const others = omit(props as ToastRootProps, "class", "variant");
	return (
		<ToastPrimitive.Root
...
const ToastClose = <T extends ValidComponent = "button">(
	...
	const others = omit(props as ToastCloseButtonProps, "class");
	return (
...
const ToastTitle = <T extends ValidComponent = "div">(
	...
	const others = omit(props as ToastTitleProps, "class");
	return (
...
const ToastDescription = <T extends ValidComponent = "div">(
	...
	const others = omit(props as ToastDescriptionProps, "class");
	return (
